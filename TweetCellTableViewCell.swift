...
class TweetCellTableViewCell: UITableViewCell {
    ...
    func setFavorite(_ isFavorited: Bool){
        ...
        if(favorited){
            faButton.setImage(UIImage(named: "favor-icon-red"), for: UIControl.State.normal)
        }else{
            faButton.setImage(UIImage(named: "favor-icon"), for: UIControl.State.normal)
    ...
    @IBAction func favButton(_ sender: Any) { //favoriteTweet
